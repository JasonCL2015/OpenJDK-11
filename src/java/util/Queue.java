 ...
 * {@link Collection} operations, queues provide additional insertion,
 ...
 * special value (either {@code null} or {@code false}, depending on the
 * operation). The latter form of the insert operation is designed specifically
 * for use with capacity-restricted {@code Queue} implementations; in most
 * implementations, insert operations cannot fail.
 *
 * <table class="striped">
 * <caption>Summary of Queue methods</caption> <thead>
 * <tr>
 * <td></td>
 * <th scope="col" style="font-weight:normal; font-style:italic">Throws
 * exception</th>
 * <th scope="col" style="font-weight:normal; font-style:italic">Returns special
 * value</th>
 * </tr>
 * </thead> <tbody>
 * <tr>
 ...
 * {@link java.util.Collection#add Collection.add} method, which can fail to add
 ...
 * {@link LinkedList}, do not prohibit insertion of {@code null}. Even in the
...
public interface Queue<E> extends Collection<E> {
     ...
     * currently available. 给队列新增不为空的元素，成功后返回true
     * 
     ...
     * exception.
     * 在没有容量限制的情况下，立即执行插入元素，该方法一般性能优于add方法
     * 
     * @param e the element to add
     ...
     * empty.
     * 获取队列头的元素并移除，该方法不同于poll方法的地方是，当队列为空时，抛出NoSuchElementException异常
     * 
     ...
     * empty.
     * 获取队列头的元素，该方法不同于peek()的是，当队列为空时抛出NoSuchElementException异常
